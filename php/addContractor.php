...
<header>
    ...
    <h3>Contractors <a href="../php/instructions.php#Adding%20New%20Managers%2FContractors" target="_blank"><img src="../imgs/help_icon.png" alt="help" style="width: 15px; height: 15px;"></a></h3>
    <div>
