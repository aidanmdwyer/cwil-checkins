...
<header>
    ...
    <h3>Add Building <a href="../php/instructions.php#Adding%20New%20Buildings" target="_blank"><img src="../imgs/helpIconWhite.png" alt="help" style="width: 15px; height: 15px;"></a></h3>
    <div>
