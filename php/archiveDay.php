<?php
// Block all web access — only allow CLI (cron) execution
...
if($now->format('H') === '03') {
    ...
    $stmt = $conn->prepare("
    INSERT INTO archive (archiveDate, id, name, manager, ic, checked, checkedTime)
    SELECT ?, id, name, manager, ic, checked, checkedTime
